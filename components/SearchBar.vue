...
<template>
    <div class="z-20 transition-all ease-in-out duration-500 absolute inset-0 bg-white dark:bg-dark" :class="!show ? '-translate-y-full' : null">
        ...
        <Transition mode="out-in">
            <div v-if="data && data?.results.length > 0 && show" class="no-scroll h-screen overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-neutral-700 p-4 bg-light dark:bg-neutral-950">
